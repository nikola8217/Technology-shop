...
<body style="background-color: #e9f0ea">
    <div class="wrapper">
        <nav>
        ...
        <div class="content">
            <div class="logo"><a href="/">CompShop</a></div>
            <ul class="links">
    ...
    {{-- <footer class="container-fluid bg-4 text-center" style="postion: fixed; left: 0; bottom: 0;">
        <p>Copyright &copy; 2022 Nikola Zivkovic &#64; ITS</p> 
    </footer> --}}
